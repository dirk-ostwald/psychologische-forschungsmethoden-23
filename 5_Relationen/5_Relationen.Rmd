...
\end{equation}
Jede Teilmenge von $M \times M$ ist eine Relation auf $M$.

Zum Beispiel ist also
\begin{equation}
R := \{(a,a), (b,b), (c,c)\}
\end{equation}
eine Relation auf $M$. Man schreibt hier also $a \diamond a$, $b \diamond b$, $c \diamond c$,
...
* Die $>$ Relation auf $\mathbb{R}$ is irreflexiv, denn für kein $x \in \mathbb{R}$ gilt, dass $x > x$.
* Für $M := \{a,b\}$ ist
\begin{equation}
R := \{(a,b), (b,a)\}
\end{equation}
